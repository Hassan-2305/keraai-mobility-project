    ...
    return (
        <div className="space-y-6 pb-20">
            <div className="flex flex-col items-center pt-8 pb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">System Admin</h2>
            ...
            <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-slate-900 dark:text-white">admin@parkops.com</p>
                ...
                <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-slate-900 dark:text-white">Admin Access</p>
